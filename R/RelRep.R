...
#'
#' @description `easyRasch` NOTE: This function is borrowed from <https://github.com/melissagwolf/dynamic/blob/master/R/RelRep.R>,
#'  commit: <https://github.com/melissagwolf/dynamic/commit/d31d103ece10d3c62f87fe413e5a1253b81e1286>.
#'  See the paper by McNeish & Dumas (2025), full reference below, for details.
#'
...
#'
#' @references
#' McNeish, D., & Dumas, D. (2025). Reliability representativeness: How well does coefficient alpha summarize reliability across the score distribution? Behavior Research Methods, 57(3), 93. \href{https://doi.org/10.3758/s13428-025-02611-8}{doi:10.3758/s13428-025-02611-8}
#'
